...
const Layout = ({ children, title = "This is the default title" }: Props) => {
  ...
  return (
    <div>
      ...
      <GlobalStyle />
      <button className="scrollTop z-10 p-4 right-8 bottom-8 fixed rounded-full bg-gray-300 hover:bg-gray-200" onClick={scrollTop} style={{ display: showScroll ? 'flex' : 'none'}}>
        <UpOutlined />
      </button>
      <Header title={title} />
      <div className="p-4">
